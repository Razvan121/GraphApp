...
GraphApp is an educational and interactive application for exploring and understanding graph algorithms.
...
🔹 Choose graph type – directed / undirected / weighted

🔹 Run popular graph algorithms, including:
...
Watch the algorithm run step by step, with visual highlights of visited nodes, edges, and current distances
...
Backend / logic: Python (or the relevant language you used)

Graph visualization: (e.g., D3.js, vis.js, or custom)

Other libraries / frameworks: (list here any major ones)
